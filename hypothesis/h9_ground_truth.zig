...
const cases = [_]TestCase{
    .{
        ...
        .expected_rules = &.{
            ...
            "python.security.subprocess-call-shell-true",
            "python.security.subprocess-run-shell-true",
            "python.security.subprocess-popen-shell-true",
            ...
            "python.security.hashlib-new-md5",
            "python.security.hashlib-new-sha1",
            ...
            "python.security.eval-fstring",
            "python.security.exec-fstring",
    ...
    .{
        ...
        .expected_rules = &.{
            ...
            "javascript.security.crypto-createhash-md5-precise",
            "javascript.security.crypto-createhash-sha1",
            "javascript.security.eval-template",
